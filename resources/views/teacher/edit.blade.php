...
<h3>Form Ubah Data Pengajar</h3>
<form action="/teacher/teacher/{{$teacher->id}}" method="POST" enctype="multipart/form-data">
		@method('PUT')
		@csrf
	<div class="mb-3">
		<label for="teacher_id" class="col-form-label">ID Dosen</label>
		<input type="text" class="form-control @error('teacher_id') is-invalid @enderror" name="teacher_id" id="teacher_id" required value="{{old('teacher_id', $teacher->teacher_id)}}">
	</div>
	<div class="mb-3">
		<label for="fullname" class="col-form-label">Nama Lengkap</label>
		<input type="text" class="form-control" name="fullname" id="fullname" required value="{{old('fullname', $teacher->fullname)}}">
	</div>
	<div class="mb-3">
		<label for="place_birth" class="col-form-label">Tempat Lahir</label>
		<input type="text" class="form-control" name="place_birth" id="place_birth" value="{{old('place_birth', $teacher->place_birth)}}">
	</div>
	<div class="mb-3">
		<label for="birth_date" class="col-form-label">Tanggal Lahir</label>
		<input type="date" class="form-control" name="birth_date" id="birth_date" value="{{old('birth_date', $teacher->birth_date)}}">
	</div>

	<div class="mb-3">
		<label for="full_address" class="col-form-label">Alamat</label>
		<input type="text" class="form-control" name="full_address" id="full_address" value="{{old('full_address', $teacher->full_address)}}">
	</div>
	<div class="mb-3">
		<label for="pra_bachelor" class="col-form-label">Pra Sarjana</label>
		<input type="text" class="form-control" name="pra_bachelor" id="pra_bachelor" value="{{old('pra_bachelor', $teacher->pra_bachelor)}}">
	</div>
	<div class="mb-3">
		<label for="bachelor" class="col-form-label">Sarjana</label>
		<input type="text" class="form-control" name="bachelor" id="bachelor" required value="{{old('bachelor', $teacher->bachelor)}}">
	</div>
	<div class="mb-3">
		<label for="masters" class="col-form-label">Magister</label>
		<input type="text" class="form-control" name="masters" id="masters" required value="{{old('masters', $teacher->masters)}}">
	</div>
	<div class="mb-3">
		<label for="doctoral" class="col-form-label">Doktoral</label>
		<input type="text" class="form-control" name="doctoral" id="doctoral" required value="{{old('doctoral', $teacher->doctoral)}}">
	</div>
	<div class="mb-3">
		<label for="job_desk" class="col-form-label">Deskripsi Pekerjaan</label>
		<input type="text" class="form-control" name="job_desk" id="job_desk" value="{{old('job_desk', $teacher->job_desk)}}">
	</div>
	<div class="mb-3">
		<label for="position" class="col-form-label">Posisi</label>
		<input type="text" class="form-control" name="position" id="position" value="{{old('position', $teacher->position)}}">
	</div>
	<div class="mb-3">
		<label for="date_joint" class="col-form-label">Tanggal Bergabung</label>
		<input type="date" class="form-control" name="date_joint" id="date_joint" value="{{old('date_joint', $teacher->date_joint)}}">
	</div>
	<div class="mb-3">
		<label for="assignment" class="col-form-label">Penugasan</label>
		<input type="text" class="form-control" name="assignment" id="assignment" value="{{old('assignment', $teacher->assignment)}}">
	</div>
	<div class="mb-3">
		<label for="word" class="col-form-label">Kata Nasihat</label>
		<textarea class="form-control" name="word" id="word" >{{old('word', $teacher->word)}}</textarea>
	</div>
				
	<div class="mb-3">
		<label for="picture" class="col-form-label">Foto Profil</label>
		<input type="text" class="form-control" name="picture" id="picture" value="{{old('picture', $teacher->picture)}}">
	</div>
